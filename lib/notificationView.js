...
class NotificationView {
  constructor (title, options) {
    ...
    this.adIconEl = document.getElementById('ad_icon')
    this.title = title
  ...
  render () {
    ...
    this.iconEl.src = this.options.icon || 'icon.png'

    if (this.options.adicon) {
      this.adIconEl.src = this.options.adicon
      this.adIconEl.style.visibility = 'visible'
    } else {
      this.adIconEl.style.visibility = 'hidden'
    }
